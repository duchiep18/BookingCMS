    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($banners as $banner)
                            <tr>
                                ...
                                <td>
                                    @if($banner->photo)
                                        <img src="{{$banner->photo}}" class="img-fluid zoom"
                                             style="height: 150px; width:150px" alt="{{$banner->photo}}">
                                    @else
                                        <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid zoom"
                                             style="height: 150px; width:150px" alt="imgdf.jpg">
                                    @endif
                                </td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{route('banner.destroy',[$banner->id])}}">
                                        ...
                                        <button class="btn btn-danger btn-sm dltBtn"
                                                data-id={{$banner->id}} style="height:30px; width:30px;
                                                border-radius:50%
                ...
                @else
                    <h6 class="text-center">Không tìm thấy Banner nào !!! Hãy tạo Banner</h6>
                @endif
            </div>
        </div>
    </div>
